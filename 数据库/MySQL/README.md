...
![image-20231009194106669](./assets/image-20231009194106669.png)
...
![image-20231009194024659](./assets/image-20231009194024659.png)
...
![image-20231009194121674](./assets/image-20231009194121674.png)
...
![image-20231009194200287](./assets/image-20231009194200287.png)

Buffer Pool：缓冲池是主内存中的一个区域，里面可以缓存磁盘上经常操作的真实数据，在执行增删改查操作时，先操作缓冲池中的数据（若缓冲池没有数据，则从磁盘加载并缓存），然后再以一定频率刷新到磁盘，从而减少磁盘I0，加快处理速度。

![images](./assets/artic2.png)
![image-20231009194302613](./assets/image-20231009194302613.png)

磁盘架构：
![image-20231009194328695](./assets/image-20231009194328695.png)

![image-20231009194352530](./assets/image-20231009194352530.png)
...
![image-20231009194426506](./assets/image-20231009194426506.png)
...
![image-20231009194442645](./assets/image-20231009194442645.png)

如何确定返回哪一个版本 这是由read view决定返回 undo log 中的哪一个版本。

![image-20231009194509583](./assets/image-20231009194509583.png)
...
![image-20231009194531280](./assets/image-20231009194531280.png)
